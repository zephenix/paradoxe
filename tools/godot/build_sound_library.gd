...
const OVERRIDES: Dictionary = {
	...
	&"foley_step_metal": {"volume_db": -5.0, "noise_radius": 420.0},
	&"foley_step_plant": {"volume_db": -8.0, "noise_radius": 240.0},
	&"foley_step_water": {"volume_db": -6.0, "noise_radius": 360.0},
	&"foley_jump": {"volume_db": -9.0, "noise_radius": 120.0},
	...
	&"foley_slide": {"volume_db": -6.0, "noise_radius": 280.0},
	&"foley_skid": {"volume_db": -10.0, "noise_radius": 220.0},
	&"foley_grab": {"volume_db": -6.0, "noise_radius": 120.0},
	&"foley_climb": {"volume_db": -8.0, "noise_radius": 100.0},
	&"foley_body_fall": {"volume_db": -3.0, "noise_radius": 400.0},
	&"foley_turn": {"volume_db": -18.0},
	&"foley_crouch": {"volume_db": -16.0},
	&"weapon_shot": {"noise_radius": 700.0},
	&"weapon_shot_charged": {"volume_db": -1.0, "noise_radius": 900.0},
	&"weapon_shot_sentinel": {"noise_radius": 650.0},
